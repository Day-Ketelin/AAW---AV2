package com.example.AWS_RestAPI.security;
...
public class JwtUtil {
    ...
    private static final long EXPIRATION_TIME = 864_000_000; //10 dias de validade do token
...
//      SecretKey secretE = Keys.hmacShaKeyFor(Decoders.BASE64.decode(SECRET_STRING));
//       return Jwts.parser().verifyWith(secretE).build().parseSignedClaims(token).getPayload().getSubject();
//    }
}
